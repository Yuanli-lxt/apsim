...
BASE_APSIM = Path(os.environ.get("SOBOL_BASE_APSIM", r"F:\APSIM710-r4221\process_bio\modified_from_truth.apsim"))
SOBOL_DIR = Path(r"F:\APSIM710-r4221\process_bio\sobol")
SCRIPTS_DIR = SOBOL_DIR / "scripts"

# 所有新输出默认进入整理后的归档目录，避免再次散落在 sobol 根目录。
# 如需输出到新的目录，可在 PowerShell 中临时设置：
# $env:SOBOL_OUTPUT_DIR = "F:\APSIM710-r4221\process_bio\sobol\organized_outputs_new"
OUTPUT_ROOT = Path(
    os.environ.get(
        "SOBOL_OUTPUT_DIR",
        r"F:\APSIM710-r4221\process_bio\sobol\organized_outputs_20260515_152346",
    )
)
