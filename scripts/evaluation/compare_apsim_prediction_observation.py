...
truth_file = PROJECT_ROOT / "data" / "processed" / "observations" / "independent_validation_observations_p02_maize_p01_wheat.csv"

prediction_file = PROJECT_ROOT / "output" / "iter_981" / "outputs" / "candidate" / "Rotation Sample Phases.out"

output_dir = PROJECT_ROOT / "outputs" / "figures" / "prediction_observation"
